...
from settings import kafkaParams, MySQLGroupId, MySQLTopic
...
config = SparkConf()
scontext = SparkContext(appName='sec-' + MySQLTopic, )
stream_context = StreamingContext(scontext, 2)
msg_stream = KafkaUtils.createDirectStream(stream_context, [MySQLTopic],
